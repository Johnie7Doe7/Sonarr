...
namespace NzbDrone.Core.Notifications.CustomScript
{
    ...
    public class CustomScriptService : ICustomScriptService
    {
        ...
        public void OnDownload(Series series, EpisodeFile episodeFile, CustomScriptSettings settings)
        {
            ...
            environmentVariables.Add("Sonarr.EpisodeFile.ReleaseGroup", episodeFile.ReleaseGroup);
            environmentVariables.Add("Sonarr.EpisodeFile.SceneName", episodeFile.SceneName);
